...
\includegraphics[width=\textwidth]{resources/wirefames-pt4.png}
\newpage

\section{README.md}
\label{readme}
% Split readme in 3 parts
\includegraphics[width=0.95\textwidth]{resources/readme_pt1.png}
\newpage
\includegraphics[width=0.95\textwidth]{resources/readme_pt2.png}
\newpage
\includegraphics[width=0.95\textwidth]{resources/readme_pt3.png}
